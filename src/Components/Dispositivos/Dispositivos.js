    ...
    return (
        <div className="Dispositivos-wrap">
            ...
            <div className="Dispositivos-text">
                ...
                <button type="button" className="download-apple"><i class="fab fa-apple"></i> Download</button>
                <button type="button" className="download-google"><i class="fab fa-google-play"></i> Download</button>
            </div>
        </div>
    )
}
